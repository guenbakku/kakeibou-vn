...
| ['default_args'] Set of arguments' default values that be used cross views
|   You can change these values just by overiding the value which you want in controllers
|
