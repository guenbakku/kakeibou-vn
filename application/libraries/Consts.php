...
class Consts {
    ...
    const SUCC_ADD_INOUT_RECORD = 'Thêm ghi chép <strong>%s</strong> thành công (<a href="%s">Record id: %s</a>)';

    const SUCC_EDIT_INOUT_RECORD = 'Sửa ghi chép thành công (<a href="%s">Record id: %s</a>)';
